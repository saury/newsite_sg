define(function(require) {
    ...
    //floor jump
    //glyphicon go down
    $(".indexMain .glyphicon-chevron-down").click(function() {
        var ele = $(".indexMain .glyphicon-chevron-down");
    ...
    //glyphicon go up
    $(".indexMain .glyphicon-chevron-up").click(function() {
        var ele = $(".indexMain .glyphicon-chevron-up");
